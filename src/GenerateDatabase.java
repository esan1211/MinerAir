    ...
    public void setDomesticInternationMap(){
        ...
        try{
            ...
            for(int i = 0; i < lines.size(); i++){ //Traverses through every line in csv ArrayList and creates a string array to split by commas and add new International and Domestic obj to Flights ArrayList
                ...
                Flight currFlight = flightFactory.createFlight(readFlights[13], readFlights[0], readFlights[1], readFlights[2], readFlights[3], readFlights[4], readFlights[5], readFlights[6], readFlights[7], Integer.valueOf(readFlights[8]), Integer.valueOf(readFlights[9]), Integer.valueOf(readFlights[10]), readFlights[11], readFlights[12], Integer.valueOf(readFlights[14]), Integer.valueOf(readFlights[18]), Integer.valueOf(readFlights[19]), Integer.valueOf(readFlights[20]), Integer.valueOf(readFlights[21]), Integer.valueOf(readFlights[22]), Integer.valueOf(readFlights[23]), Integer.valueOf(readFlights[24]));
